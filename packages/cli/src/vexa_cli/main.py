...
from vexa_cli.ui.output import print_banner, show_beta_terms, console

logger = get_logger(__name__)


@click.group()
@click.option('--non-interactive', is_flag=True, help="Run without interactive prompts (auto-accepts defaults)")
...
from vexa_cli.commands.misc import (
    mcp_server_command, threat_model, validate, matrix, list_scanners
)
