...
class MarkdownReportGenerator(BaseReportGenerator):
    ...
    def _render_findings(self, findings: List[Finding]) -> List[str]:
        ...
        for finding in sorted_findings:
            severity = (finding.severity.value if hasattr(finding.severity, 'value') else finding.severity).lower()
            ...
            # AI Enhancements
            if hasattr(finding, "detailed_description") and finding.detailed_description:
                lines.extend([
