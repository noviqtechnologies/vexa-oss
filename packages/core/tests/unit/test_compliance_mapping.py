...
class TestComplianceMapping:
    ...
    def test_finding_supports_cwe_ids(self):
        ...
        f = Finding(
            id="F001", scanner="bandit", severity="high",
    ...
    def test_finding_supports_owasp_category(self):
        ...
        f = Finding(
            id="F002", scanner="semgrep", severity="critical",
    ...
    def test_finding_defaults_empty_cwe(self):
        ...
        f = Finding(
            id="F003", scanner="checkov", severity="medium",
            title="Open SG", description="test",
            file_path="main.tf", line_start=1, line_end=1,
        )
    ...
    def test_finding_supports_multiple_cwe(self):
        ...
        f = Finding(
            id="F004", scanner="bandit", severity="critical",
            title="Command Injection", description="test",
