...
class TestAIProviderManager:
    ...
    def test_configure_google_provider(self, mock_get_gemini, mock_get_openai, mock_get_anthropic, mock_gemini):
    ...
    @patch("vexa.ai_providers.manager.get_openai_wrapper")
    @patch("vexa.ai_providers.manager.get_gemini_sdk_wrapper")
    def test_configure_openai_provider(self, mock_get_gemini, mock_get_openai, mock_get_anthropic, mock_openai):
    ...
    @patch("vexa.ai_providers.manager.get_openai_wrapper")
    @patch("vexa.ai_providers.manager.get_gemini_sdk_wrapper")
    def test_configure_anthropic_provider(self, mock_get_gemini, mock_get_openai, mock_get_anthropic, mock_anthropic):
    ...
    @patch("vexa.ai_providers.manager.get_openai_wrapper")
    @patch("vexa.ai_providers.manager.get_gemini_sdk_wrapper")
    def test_configure_aws_provider_disabled(self, mock_get_gemini, mock_get_openai, mock_get_anthropic):
    ...
    @patch("vexa.ai_providers.manager.get_openai_wrapper")
    @patch("vexa.ai_providers.manager.get_gemini_sdk_wrapper")
    def test_configure_azure_provider_disabled(self, mock_get_gemini, mock_get_openai, mock_get_anthropic):
